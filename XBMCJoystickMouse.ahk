...
if WinActive("ahk_class XBMC") or WinActive("ahk_class Snes9X") or WinActive("ahk_class mame") or WinActive("ahk_class Project64")
	{
		MsgBox, Hey
		return
	}
	...
	{
	; If none of the above programs are running, use the controller as a mouse.
